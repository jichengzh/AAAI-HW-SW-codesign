...
_DISCO_FUSE_FALLBACKS = [
    _HEAL_CKPT_ROOT / "stage1/Pyramid_DAIR_m1_base_2023_08_14_11_42_29/scripts/models/fuse_modules/disco_fuse.py",
...
_CKPT_FCOOPER = str(
    _HEAL_CKPT_ROOT / "baselines_hf/HeterBaseline_opv2v_lidar_fcooper_2023_08_06_19_53_10"
)
_CKPT_ATTFUSE = str(
    _HEAL_CKPT_ROOT / "baselines_hf/HeterBaseline_opv2v_lidar_attfuse_2023_08_06_19_58_00"
)
...
_DEFAULT_OPV2V_LIDAR_BEV_SHAPE = (1, 64, 512, 512)
_DEFAULT_DAIR_LIDAR_BEV_SHAPE = (1, 64, 256, 512)
_CKPT_PYRAMID_LIDAR = str(
    _HEAL_CKPT_ROOT / "stage1/Pyramid_DAIR_m1_base_2023_08_14_11_42_29"
)
_CKPT_PYRAMID_CAM = str(_HEAL_CKPT_ROOT / "stage2/m2_alignto_m1")
_CKPT_V2XVIT = str(
    _HEAL_CKPT_ROOT / "baselines_hf/HeterBaseline_DAIR_lidar_v2xvit_2023_09_09_11_19_26"
)
_CKPT_CODRIVING = str(_V2XVERSE_CKPT_ROOT / "codriving/perception/net_epoch_bestval_at16.pth")
...
AUTO_REGISTRY: dict[str, AutoTraceAdapter] = {
    ...
    "where2comm": AutoTraceAdapter(
        ...
        ckpt_path="",
        build_fn=_build_heter_baseline,
        bev_shape=_DEFAULT_OPV2V_LIDAR_BEV_SHAPE,
    ...
    "disconet": AutoTraceAdapter(
        ...
        ckpt_path="",
        build_fn=_build_heter_baseline,
        bev_shape=_DEFAULT_DAIR_LIDAR_BEV_SHAPE,
        ckpt_status="missing_architecture_scan_only",
        skipped_desc=[
            "pillar_vfe (sparse VFE, auto-skip)",
            "scatter (sparse scatter, auto-skip)",
