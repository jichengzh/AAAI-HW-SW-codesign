#!/usr/bin/env python3
"""Run one P6 post-source performance round from a generated wrapper."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    except (P6PostSourceAdapterProfileError, P6PerformanceRoundAdapterError):
        sys.stderr.write("history_execution_invalid\n")
        return 1
    except (OSError, TypeError, ValueError):
        sys.stderr.write("history_execution_invalid\n")
        return 1
    sys.stdout.write("performance_complete\n")
    return 0
