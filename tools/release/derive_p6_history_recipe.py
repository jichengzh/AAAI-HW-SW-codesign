...
SOURCE_MAP_V5 = "p6_history_normalization_source_v5"
...
PROCEDURAL_SOURCE_MAP_V5_KEYS = PROCEDURAL_SOURCE_MAP_V4_KEYS | {
...
def _load_source_map(path: Path) -> dict[str, Any]:
    ...
    expected_keys = (
        PROCEDURAL_SOURCE_MAP_V5_KEYS
        if schema_version == SOURCE_MAP_V5
        else PROCEDURAL_SOURCE_MAP_V4_KEYS
    ...
    if (
        ...
        or schema_version not in {SOURCE_MAP_V2, SOURCE_MAP_V3, SOURCE_MAP_V4, SOURCE_MAP_V5}
