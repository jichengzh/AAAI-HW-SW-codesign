#!/usr/bin/env python3
"""Run one P6 post-source AP round from a generated wrapper."""
...
from framework.stage6.p6_ap_round_adapter_v1 import (  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        run_ap_round(profile, args.task_state, args.round_output_root, SubprocessLeafRunner())
    except (P6PostSourceAdapterProfileError, P6APRoundAdapterError):
        sys.stderr.write("history_execution_invalid\n")
        return 1
    except (OSError, TypeError, ValueError):
        sys.stderr.write("history_execution_invalid\n")
        return 1
    sys.stdout.write("ap_complete\n")
    return 0
