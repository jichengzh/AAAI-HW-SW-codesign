...
跑:
    python tools/configurable/depgraph_pyramid.py --device cpu
"""
...
def run_rootcause(args, hypes, ckpt, dev, H, W):
    ...
    dair = str(_HEAL_CKPT_ROOT / "stage1/Pyramid_DAIR_m1_base_2023_08_14_11_42_29")
...
def parse_args():
    ...
    p.add_argument("--orig-dir",
                   default=str(_HEAL_CKPT_ROOT / "stage1/Pyramid_m1_base_2023_08_14_04_28_12"))
