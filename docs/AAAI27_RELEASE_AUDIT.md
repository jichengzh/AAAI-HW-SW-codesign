...
#### P3-36：Stage2 外部执行线索复审（主审与独立审阅冲突，待裁决）

12 项候选均已完成主审和独立语义读取并确认当前内容无漂移。主审建议 5 项 P4、2 项 P5、5 项 P6；独立审阅确认 5 项 P4、2 项 P5，但以公开职责/API 对比将其中 2 项从 P6 改判为公开替代，形成 5 项 P4、2 项 P5、3 项 P6、2 项公开替代。因逐项结论不一致，本批不生成 decisions/evidence/HMAC ledger，不计入 205/1,551 项，必须第三次只读裁决后才可进入后续阶段。
...
| 2026-08-04 | P3-36 Stage2 外部执行线索复审 | 主审与独立审阅冲突，待裁决 | 两次逐项读取均确认 12 项当前内容无漂移。主审为 5 项 P4、2 项 P5、5 项 P6；独立审阅以公开职责/API 对比改判其中 2 项为公开替代，形成 5 项 P4、2 项 P5、3 项 P6、2 项公开替代。未生成 decisions/evidence/HMAC ledger，不计入 205/1,551；未推送、未发布。 |
