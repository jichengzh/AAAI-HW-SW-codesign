...
八个受限检查点合并后，P2b 的 1,551 项候选均有恰好一条 decision；公开路径无关 ledger 已提交，SHA-256 为 `c2ee5a5af17d37966fbcc52e90c0f3f90557f09a2d2724ccefbdc487ee613afb`。同一 HEAD 的全量 pytest 为 502 passed、83.09%，ledger/身份/交接测试为 35 passed，匿名 archive/身份测试为 50 passed；Ruff、compileall、diff 与匿名 ZIP build/verify 均通过，ZIP 为 124 个成员、SHA-256 `a6951ed6310541a0266a14d6af93228fe20313f93f41508231b773e54644d264`。但 218 项 P4、193 项 P5、193 项 P6 和 231 项 P7 尚未实际交付，P3 的完整发布关闭仍不成立。详见 [P3-17 记录](release-manifests/P3_BATCH_17_FULL_LEDGER_CLOSURE_VERIFICATION.md)。
