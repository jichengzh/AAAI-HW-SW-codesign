...
**P3-146 最新进展（2026-08-05）**：12 项 `migrate_document` 完成 P2/当前 SHA、职责/I-O/调用关系、公开等价物、来源/许可证和安全输出的双独立逐项复审，并由第三方裁决；最终 P4=3、P6=5、P7=4，无重复项。q2 的私有 `/tmp` 测量日志以及 q7/q11/q12 的外部论文/训练知识来源和许可链未闭合，保持 P7；其余执行工作流归 P6、结果/分析归 P4。受限证据与 HMAC key 未进入公开树。真实唯一覆盖 **1,520/1,551**，P3 仍进行中，P4 未启动；未推送、未发布。

**P3-147 最新进展（2026-08-05）**：12 项 `migrate_document` 完成 P2/当前 SHA、职责/I-O/调用关系、公开等价物、来源/许可证和安全输出的双独立逐项复审；最终 P4=9、P6=2、P7=1，无重复项。q10 的 D-space 文档含 `/tmp/nvidia-mps` 私有临时路径，保持 P7；survey_task_plan 与协同加速工作流归 P6，其他 survey_raw 文档归 P4。受限证据与 HMAC key 未进入公开树。真实唯一覆盖 **1,532/1,551**，P3 仍进行中，P4 未启动；未推送、未发布。
