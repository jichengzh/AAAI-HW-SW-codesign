...
**当前更正（覆盖此前当前计数）**：P3-144 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、第三方逐项裁决、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=9、P6=1、P7=2，无重复项，真实唯一覆盖为 **1,496/1,551**，尚余 **55** 项。q10/q11 的可执行 RALPH 提示含绝对本机路径，须参数化、清洗并扫描后重审；P3 尚未关闭，P4 尚未开始。

**当前更正（覆盖此前当前计数）**：P3-145 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、双独立逐项审查、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=8、P6=3、P7=1，无重复项，真实唯一覆盖为 **1,508/1,551**，尚余 **43** 项。q12 的 Pyramid 架构审计含绝对本机路径及外部 HEAL/checkpoint 边界，须清洗和许可确认后重审；P3 尚未关闭，P4 尚未开始。

**当前更正（覆盖此前当前计数）**：P3-146 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、第三方逐项裁决、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=3、P6=5、P7=4，无重复项，真实唯一覆盖为 **1,520/1,551**，尚余 **31** 项。q2 的私有临时测量日志，以及 q7/q11/q12 的外部论文/训练知识来源与许可链未闭合，须清洗、核验并扫描后重审；P3 尚未关闭，P4 尚未开始。

**当前更正（覆盖此前当前计数）**：P3-147 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、双独立逐项审查、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=9、P6=2、P7=1，无重复项，真实唯一覆盖为 **1,532/1,551**，尚余 **19** 项。一项 D-space 文档含私有临时运行路径，须参数化、清洗并扫描后重审；P3 尚未关闭，P4 尚未开始。

**当前更正（覆盖此前当前计数）**：P3-148 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、第三方逐项裁决、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=2、P6=9、P7=1，无重复项，真实唯一覆盖为 **1,544/1,551**，尚余 **7** 项。q8 的 Bench2Drive 私有路径、权重下载源和 checkpoint 边界须清洗、许可确认并扫描后重审；P3 尚未关闭，P4 尚未开始。

**当前更正（覆盖此前当前计数）**：P3-149 新增最后 7 个冻结 P2b 身份；受限 inventory、当前 SHA-256、第三方逐项裁决、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=2、P5=1、P6=2、P7=2，无重复项，真实唯一覆盖为 **1,551/1,551**。候选逐项处置已覆盖全量，但全量关闭验证仍待完成；P3 尚未关闭，P4 尚未开始。

**覆盖计算更正**：P3-28/29/30/33 的 48 项 pending `migrate_code` 不得作为已接受覆盖；P3-150–153 已重新完成四批正式审阅、第三方裁决（适用时）、受限账本与 manifest。四批新增身份后，正式 acceptance manifest 的去重覆盖为 **1,551/1,551**，其中 P3-150 q1 保持 P7，P3-151/152/153 的公开 API/测试或执行契约证据已记录。全量关闭验证仍待完成，P3 尚未关闭，P4 尚未开始。

**最终关闭对账**：受限 accepted-only manifest、逐项当前 SHA-256、1,551 条 decisions 和路径无关 HMAC ledger 已在修正后的工作树重新核验，唯一覆盖 **1,551/1,551**、缺失 0、额外身份 0。独立关闭复审的文档问题已修正并通过身份、路径和回归扫描；P3 已完成（本地），P4 尚未开始，未推送、未发布。
