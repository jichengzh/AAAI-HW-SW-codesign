...
**当前更正（覆盖此前当前计数）**：P3-136 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、第三方裁决、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=1、P5=1、P6=8、P7=1，另有 1 项 `duplicate_or_superseded`，真实唯一覆盖为 **1,400/1,551**，尚余 **151** 项。P7 项含真实设备/主机身份与私有测量 provenance，必须先完成脱敏、授权和历史/导出扫描；P3 尚未关闭，P4 尚未开始。
