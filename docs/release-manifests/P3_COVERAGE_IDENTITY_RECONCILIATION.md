...
**当前更正（覆盖此前当前计数）**：P3-137 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、第三方裁决、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=8、P5=1、P6=1、P7=0，另有 2 项 `duplicate_or_superseded`，真实唯一覆盖为 **1,412/1,551**，尚余 **139** 项。两项 superseded 文档仅作为历史长版保留，须继续泛化环境细节；P3 尚未关闭，P4 尚未开始。
