...
**当前更正（覆盖此前当前计数）**：P3-134 新增 12 个冻结 P2b 身份；受限 inventory、当前 SHA-256、第三方裁决、HMAC ledger 与 acceptance manifest 均已重算。最终 P4=9、P6=3、P7=0，真实唯一覆盖为 **1,376/1,551**，尚余 **175** 项。涉及运行环境、人员/资源、日志或路径痕迹的候选不得原样公开，须在后续契约中完成安全泛化；P3 尚未关闭，P4 尚未开始。
