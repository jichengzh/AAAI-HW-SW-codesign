...
**最新更正（覆盖此前当前计数）**：P3-137 完成 12 项 `migrate_document` 的双独立逐项审查与第三方裁决，最终 P4=8、P5=1、P6=1、P7=0，另有 2 项 `duplicate_or_superseded`。两项 superseded 文档已有公开更新入口；GPU/授权 SOP 归 P5，W_g 探针归 P6，其余归 P4 论文/外部证据边界。受限账本与 acceptance manifest 已重算，真实唯一覆盖 **1,412/1,551**，剩余 **139** 项；P3 仍进行中，P4 尚未开始，未推送、未发布。
