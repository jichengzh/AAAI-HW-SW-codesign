...
**最新更正（覆盖此前当前计数）**：P3-136 完成 12 项 `migrate_document` 的双独立逐项审查与第三方裁决，最终 P4=1、P5=1、P6=8、P7=1，另有 1 项 `duplicate_or_superseded`。P7 项含真实设备/主机身份与私有测量 provenance，须清洗、授权并完成历史/导出扫描后重审；其余按外部数据、环境门槛或执行管线契约处理。受限账本与 acceptance manifest 已重算，真实唯一覆盖 **1,400/1,551**，剩余 **151** 项；P3 仍进行中，P4 尚未开始，未推送、未发布。
