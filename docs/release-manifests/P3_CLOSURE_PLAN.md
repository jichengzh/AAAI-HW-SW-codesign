...
当前有四个已接受的局部批次：P3-18 的 8 个合成测试 fixture、P3-19 的 5 个外部边界候选、P3-20 的 12 个正式执行候选和 P3-21 的 12 个外部执行脚本，共 37/1,551 项。所有受限 evidence/decision/HMAC ledger 检查点均不构成关闭账本；P4 尚未开始。
