...
受限 HMAC evidence/decision records 与路径无关账本检查点均通过，但不构成 P3 关闭账本。本批不迁入源码、测试、数据、模型、checkpoint、ONNX、engine 或实验结果；本批关闭时的累计为 121/1,551。随后 P3-26/P3-27 的规范 records 通过独立复审和 supersession 处置，当前累计为 145/1,551；P4 尚未开始。
